...
from s4.utils import permutations

from s4.dataloaders.base import default_data_path, ImageResolutionSequenceDataset, ResolutionSequenceDataset, SequenceDataset
...
class SpeechCommands(ResolutionSequenceDataset):
    ...
    def setup(self):
        ...
        from s4.dataloaders.datasets.sc import _SpeechCommands
