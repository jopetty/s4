...
from s4.dataloaders.base import default_data_path, SequenceDataset
...
class CIFAR10C(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.datasets.cifarc import _CIFAR10C
...
class ImageNetP(ImageNet):
    ...
    def setup(self):
        from pl_bolts.transforms.dataset_normalizations import \
            imagenet_normalization
        from s4.dataloaders.utils.video_loader import VideoFolder
        from torch.utils.data.dataloader import default_collate
        self.imagenet_normalization = imagenet_normalization
        self.default_collate = default_collate
