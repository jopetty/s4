...
from s4.dataloaders.base import default_data_path, SequenceDataset, deprecated
...
class QuantizedAutoregressiveAudio(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.audio import QuantizedAudioDataset
...
class SpeechCommands09Autoregressive(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.audio import SpeechCommands09
...
class MaestroAutoregressive(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.audio import MaestroDataset
...
class LJSpeechAutoregressive(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.audio import LJSpeech
...
class SpeechCommands09Classification(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.audio import _SpeechCommands09Classification
...
class SpeechCommandsGeneration(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.datasets.sc import _SpeechCommandsGeneration
...
class Music(SequenceDataset):
    ...
    def setup(self):
        from s4.dataloaders.music import _Music
