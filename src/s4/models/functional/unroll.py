...
from s4.models.functional.toeplitz import triangular_toeplitz_multiply, triangular_toeplitz_multiply_padded
from s4.utils.permutations import bitreversal_po2, bitreversal_permutation
