...
from s4.models.sequence.rnns.cells.basic import RNNCell
from s4.models.nn import LinearActivation, Activation # , get_initializer
from s4.models.nn.gate import Gate
